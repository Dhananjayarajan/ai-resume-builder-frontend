          ...
          <div className="lg:flex lg:items-center lg:justify-between">
            <div className="lg:w-1/2 space-y-6">
              ...
              >
                ...
                with <span className="text-yellow-300">AI-Powered</span>
                <br />
                Intelligence
              </motion.h1>
              <motion.p
              ...
              >
                Creating job-winning resumes that perfectly match your target
                posotions using our advanced AI assistant.
              </motion.p>
              <motion.div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
              Our AI-powered platform helps you create professional documents
              that stand out.
            </p>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li>
                  <Link to="/cvs" className="text-gray-400 hover:text-white">
                    CVs
                  </Link>
                </li>
              </ul>
          ...
          <div className="mt-8 pt-8 border-t border-gray-700 text-center text-sm text-gray-400">
            <p>
              &copy; {new Date().getFullYear()} ResumePilot. All rights
              reserved.
            </p>
          </div>
        </div>
